...
==================================================================================================*/
    ...
    /*-------------------------------------------------------*/
#ifndef HSE_SPT_EXTENSION
    #define HSE_SPT_EXTENSION HSE_SPT_OFF        /**< @brief Support for run-time loadable extensions. */
#endif
    /*-------------------------------------------------------*/
    ...
    #define HSE_SPT_CMU_CONFIG                       /**< @brief Support CMU configuration that is with in the HSE subsystem */
    ...
    #define HSE_NUM_OF_CORE_RESET_ENTRIES   (16U)    /**< @brief  The supported number of CORE RESET entries*/
#endif
...
/**< \defdisable{#define,HSE_SPT_SELF_TEST}*/        /**< @brief Support self test */
    ...
    #define HSE_NUM_OF_CMU_INSTANCES      (2U)      /**< @brief  The maxim number of CMU interfaces */
#ifdef HSE_SPT_ACTIVE_TAMPER_CONFIG
	#define HSE_TAMPER_NUMBER_MAX         (4U)      /**< @brief  The maxim number of active tamper instances */
#endif
