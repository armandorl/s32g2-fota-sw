 ...
 *  @details Specifies if the input or output data is provided a scatter list (see hseScatterList_t). <br>
...
#define HSE_CIPHER_ALGO_3DES         ((hseCipherAlgo_t)0x30U)  /**< @brief 3DES cipher */
...
#define HSE_CIPHER_BLOCK_MODE_CBC    ((hseCipherBlockMode_t)2U)   /**< @brief CBC mode (AES and 3DES) */
#define HSE_CIPHER_BLOCK_MODE_ECB    ((hseCipherBlockMode_t)3U)   /**< @brief ECB mode (AES and 3DES) */
#define HSE_CIPHER_BLOCK_MODE_CFB    ((hseCipherBlockMode_t)4U)   /**< @brief CFB mode (AES and 3DES) */
#define HSE_CIPHER_BLOCK_MODE_OFB    ((hseCipherBlockMode_t)5U)   /**< @brief OFB mode (AES and 3DES) */
...
#define HSE_MAC_ALGO_CMAC            ((hseMacAlgo_t)0x11U)       /**< @brief CMAC (AES and 3DES)*/
#define HSE_MAC_ALGO_GMAC            ((hseMacAlgo_t)0x12U)       /**< @brief GMAC (only for AES)*/
#define HSE_MAC_ALGO_XCBC_MAC        ((hseMacAlgo_t)0x13U)       /**< @brief XCBC MAC (only for AES128) */
...
#define HSE_RSA_ALGO_NO_PADDING        ((hseRsaAlgo_t)90U) /**< @brief The input will be treated as an unsigned integer and perform a modular exponentiation of the input  */
#define HSE_RSA_ALGO_RSAES_OAEP        ((hseRsaAlgo_t)91U) /**< @brief RSAES OAEP cipher */
#define HSE_RSA_ALGO_RSAES_PKCS1_V15   ((hseRsaAlgo_t)92U) /**< @brief ECDSA RSAES_PKCS1_V15 cipher */

/** @brief   The application core IDs (that can be started).

    Core assignment table:

    | CoreID | S32S2 | S32G   | S32R  | S32K344 |
    |-------:|:-----:|:------:|:----: |:-------:|
    |   0    | R52_0 | M7_0   | M7_0  | M7_0    |
    |   1    | R52_1 | M7_1   | M7_1  | M7_1    |
    |   2    | R52_2 | M7_2   | M7_2  |         |
    |   3    | R52_3 | A53_0  | A53_0 |         |
    |   4    |       | A53_1  | A53_1 |         |
    |   5    |       | A53_2  | A53_2 |         |
...
#define HSE_APP_CORE_INVALID ((hseAppCore_t)11U)   /**< @brief No core selected. */
#elif defined(HSE_M) ||  defined(HSE_B)
#define HSE_APP_CORE_INVALID ((hseAppCore_t)2U)   /**< @brief No core selected. */
#endif
/*==================================================================================================
...
typedef struct
{
    ...
    union
    {
        /** @brief   INPUT: CMAC scheme (AES or 3DES).  */
