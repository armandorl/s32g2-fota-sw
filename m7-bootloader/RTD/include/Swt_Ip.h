...
#define SWT_IP_AR_RELEASE_MINOR_VERSION     4
 ...
 *              Swt_Ip_pConfig pointer.
 *
 * @param[in]   u32Instance     SWT Instance number.
 * @param[in]   Swt_Ip_pConfig  Pointer to the configuration structure 
