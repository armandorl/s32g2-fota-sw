...
#define SWT_IP_TYPES_AR_RELEASE_MINOR_VERSION     4
...
#if (SWT_IP_TYPES_VENDOR_ID != SWT_IP_FEATURE_DEFINES_VENDOR_ID)
#error "Swt_Ip_Types.h and Swt_Ip_FeatureDefines.h have different vendor ids"
#endif

#if ((SWT_IP_TYPES_AR_RELEASE_MAJOR_VERSION    != SWT_IP_FEATURE_DEFINES_AR_RELEASE_MAJOR_VERSION) || \
     (SWT_IP_TYPES_AR_RELEASE_MINOR_VERSION    != SWT_IP_FEATURE_DEFINES_AR_RELEASE_MINOR_VERSION) || \
     (SWT_IP_TYPES_AR_RELEASE_REVISION_VERSION != SWT_IP_FEATURE_DEFINES_AR_RELEASE_REVISION_VERSION))
#error "AutoSar Version Numbers of Swt_Ip_Types.h and Swt_Ip_FeatureDefines.h are different"
#endif

#if ((SWT_IP_TYPES_SW_MAJOR_VERSION != SWT_IP_FEATURE_DEFINES_SW_MAJOR_VERSION) || \
     (SWT_IP_TYPES_SW_MINOR_VERSION != SWT_IP_FEATURE_DEFINES_SW_MINOR_VERSION) || \
     (SWT_IP_TYPES_SW_PATCH_VERSION != SWT_IP_FEATURE_DEFINES_SW_PATCH_VERSION))
#error "Software Version Numbers of Swt_Ip_Types.h and Swt_Ip_FeatureDefines.h are different"
#endif
