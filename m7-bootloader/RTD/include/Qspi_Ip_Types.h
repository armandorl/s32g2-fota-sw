...
typedef struct
{
    uint16 statusRegReadLut;         /*!< Command used to read status register 1                                          */
    uint16 statusRegWriteLut;        /*!< Command used to write status register 1                                         */
...
typedef struct
{
    ...
    const Qspi_Ip_InstrOpType *lutOps;       /*!< List of operations                       */
...
typedef struct
{
    ...
    const Qspi_Ip_InitOperationType * operations;            /*!< List of operations    */
